import type { ItemsResponse, PaginatableQuery, PaginatableResponse } from "../../../types";
import type { AutoloadItem, AutoloadItemFee, AutoloadItemSection } from "../items";

export type AutoloadReportSourses = "email" | "url" | "web" | "openapi";
export type AutoloadReportStatuses = "processing" | "success" | "success_warning" | "error";
...
export interface AutoloadReportShort extends
    Pick<AutoloadReport, "finished_at" | "started_at" | "status"> { id: number; }
...
export type ListAutoloadReports =
    PaginatableResponse<{
...
export type ListAutoloadReportItems = ItemsResponse<AutoloadReportItem> & PaginatableResponse<{
    report_id: number;
}>
